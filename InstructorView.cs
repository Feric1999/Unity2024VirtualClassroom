...
public class InstructorView : MonoBehaviour
{
    ...
    public void Join()
    {
        ...
        // Join the channel
        RtcEngine.JoinChannel(_token, _channelName, _channelId2, options);
    ...
    {
        private readonly InstructorView _videoSample;

        internal UserEventHandler(InstructorView videoSample)
        {
